...
#define ORG "siala1"                        // IBM organisation id
#define DEVICE_TYPE "SmartBin"                // Device type mentioned in ibm watson iot platform
#define DEVICE_ID "2901"              // Device ID mentioned in ibm watson iot platform
#define TOKEN "IBMproject"          // Token
